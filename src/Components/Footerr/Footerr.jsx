  ...
  return (
    ...
    <div className={styles.background}>
      <div className={`${styles.office} ${mulish.className}`}>
          <h1 style={{marginBottom:10 , fontSize:"23px"}}>Get in Touch</h1>
        ...
        <h1 style={{marginBottom:10 , fontSize:"23px"}}>Business Hours</h1>
        ...
        <div className={`${styles.mission} ${mulish.className}`}>
            <h1 style={{marginBottom:10 , fontSize:"23px"}}>Our Mission Statement</h1>
            <p style={{width:"300px"}}>GnF Events is one of Pakistan&apos;s trusted entertainment booking platform, dedicated to offering the very best singers, bands, comedians, and entertainers for all kinds of events, from corporate dinners and weddings to cruises, parties, and festivals.</p>
        </div>
