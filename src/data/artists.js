...
export const ARTISTS = [
  ...
  A("Afshan Zaibi", "Singer", ["Folk"], { gender: F }),
  ...
  A("Abdul Hannan", "Singer", ["Pop"], { genZ: true }),
  ...
  A("Abdullah Siddiqui", "Singer", ["Pop"], { genZ: true }),
